...
export const Womens = () => {
  ...
  const newLocal = "Product-name";
  return (
    <>
      <Navbar />
      <div className="Productpage-main">
        <div className="Productpage-top">
          <h1>Womens Clothing ({data.length + 50})</h1>
